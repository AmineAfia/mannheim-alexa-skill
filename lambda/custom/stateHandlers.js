...
const stateHandlers = {
  ...
  //   -----------------------------------------------------------------------------------
  //   -----------------------------------------------------------------------------------
  noNewItemsModeIntentHandlers: Alexa.CreateStateHandler(
    constants.states.NO_NEW_ITEM,
    {
      /*
  ...
  singleFeedModeIntentHandlers: Alexa.CreateStateHandler(
    constants.states.SINGLE_FEED_MODE,
    {
      ItemInfo: function() {
        this.emit("readItemSpeechHelper");
      },
